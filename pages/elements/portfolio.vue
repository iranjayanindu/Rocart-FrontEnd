        ...
        >
            <div class="container">
                ...
                <nav class="portfolio-nav">
                    <ul class="nav-filter portfolio-filter justify-content-center">
                        <li class="active">
                            <a href="#" @click.prevent="isotopeFilter('iso1', 'isAll', $event)">All</a>
                        </li>
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a href="#" @click.prevent="isotopeFilter('iso1', 'isMen', $event)">Men</a>
                        </li>
                        <li>
                            <a
                                href="#"
                ...
                >
                    ...
                    <div class="grid-sizer col-sm-6 col-lg-4" key="grid-sizer"></div>
                </isotope>
                ...
                <nav class="portfolio-nav">
                    <ul class="nav-filter portfolio-filter justify-content-center">
                        <li class="active">
                            <a href="#" @click.prevent="isotopeFilter('iso2', 'isAll', $event)">All</a>
                        </li>
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a href="#" @click.prevent="isotopeFilter('iso2', 'isMen', $event)">Men</a>
                        </li>
                        <li>
                            <a
                                href="#"
                ...
                >
                    ...
                    <div class="grid-sizer col-sm-6 col-md-4 col-lg-3" key="grid-sizer"></div>
                </isotope>
                ...
                <nav class="portfolio-nav">
                    <ul class="nav-filter portfolio-filter justify-content-center">
                        <li class="active">
                            <a href="#" @click.prevent="isotopeFilter('iso3', 'isAll', $event)">All</a>
                        </li>
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a href="#" @click.prevent="isotopeFilter('iso3', 'isMen', $event)">Men</a>
                        </li>
                        <li>
                            <a
                                href="#"
                ...
                <nav class="portfolio-nav">
                    <ul class="nav-filter portfolio-filter justify-content-center">
                        <li class="active">
                            <a href="#" @click.prevent="isotopeFilter('iso4', 'isAll', $event)">All</a>
                        </li>
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a href="#" @click.prevent="isotopeFilter('iso4', 'isMen', $event)">Men</a>
                        </li>
                        <li>
                            <a
                                href="#"
            ...
            <div class="container-fluid">
                ...
                <nav class="portfolio-nav">
                    <ul class="nav-filter portfolio-filter justify-content-center">
                        <li class="active">
                            <a href="#" @click.prevent="isotopeFilter('iso5', 'isAll', $event)">All</a>
                        </li>
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a href="#" @click.prevent="isotopeFilter('iso5', 'isMen', $event)">Men</a>
                        </li>
                        <li>
                            <a
                                href="#"
